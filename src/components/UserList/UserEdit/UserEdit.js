export const UserEdit = ({
    ...
    return (
        <div className="overlay">
            <div onClick={onEditClose} className="backdrop"></div>
            <div className="modal">
                <div className="user-container">
                    <header className="headers">
                        <h2>Edit User</h2>
                        <button onClick={onEditClose} className="btn close">
                    ...
                    <form>
                        ...
                        <div id="form-actions">
                            ...
                            <button onClick={onEditClose} id="action-cancel" className="btn" type="button">
                                Cancel
                            </button>
                        </div>
                    </form>
