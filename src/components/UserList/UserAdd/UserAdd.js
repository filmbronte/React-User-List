export const UserAdd = ({
    ...
    return (
        <div className="overlay">
            <div onClick={onAddClose} className="backdrop"></div>
            <div className="modal">
                <div className="user-container">
                    <header className="headers">
                        <h2>Add User</h2>
                        <button onClick={onAddClose} className="btn close">
                    ...
                    <form onSubmit={onUserCreate}>
                        ...
                        <div id="form-actions">
                            ...
                            <button onClick={onAddClose} id="action-cancel" className="btn" type="button">
                                Cancel
                            </button>
                        </div>
                    </form>
